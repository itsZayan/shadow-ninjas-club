              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  <select className="w-full p-3 bg-ninja-dark/50 border border-ninja-red/30 rounded-md text-white focus:border-ninja-red focus:outline-none">
                    ...
                    <option value="g13">G-13 Dojo</option>
              ...
              <Card className="bg-card/30 backdrop-blur border-ninja-red/20 hover:border-ninja-red/50 transition-colors duration-300">
                <CardContent className="p-6 flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 font-noto">+92 300 1234567</p>
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-3 text-gray-300 font-noto">
                  <div className="flex justify-between">
                    ...
                    <span className="text-ninja-red">Available</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Age Groups:</span>
                    <span className="text-ninja-red">6+ Years</span>
                  </div>
                  <div className="flex justify-between">
            ...
            <Card className="bg-card/30 backdrop-blur border-ninja-red/20">
              <CardContent className="p-6">
                ...
                <div className="flex space-x-4">
                  <button className="w-10 h-10 bg-ninja-red/20 hover:bg-ninja-red/30 rounded-lg flex items-center justify-center transition-colors duration-300">
                    <span className="text-ninja-red font-bold">f</span>
                  </button>
                  <button className="w-10 h-10 bg-ninja-red/20 hover:bg-ninja-red/30 rounded-lg flex items-center justify-center transition-colors duration-300">
                    <span className="text-ninja-red font-bold">ig</span>
                  </button>
                  <button className="w-10 h-10 bg-ninja-red/20 hover:bg-ninja-red/30 rounded-lg flex items-center justify-center transition-colors duration-300">
                    <span className="text-ninja-red font-bold">yt</span>
                  </button>
                  <button className="w-10 h-10 bg-ninja-red/20 hover:bg-ninja-red/30 rounded-lg flex items-center justify-center transition-colors duration-300">
                    <span className="text-ninja-red font-bold">tw</span>
                  </button>
                </div>
              </CardContent>
            </Card>
