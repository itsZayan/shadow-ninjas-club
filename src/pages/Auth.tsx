...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen ninja-gradient flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <Link 
        to="/" 
        className="absolute top-6 left-6 text-white hover:text-ninja-red transition-colors duration-300 flex items-center gap-2 z-20"
      >
      ...
      <Card className="w-full max-w-md bg-ninja-dark/90 border-ninja-red/30 backdrop-blur-md relative z-10">
        <CardHeader className="text-center">
          ...
          <div className="inline-flex items-center px-3 py-1 rounded-full border border-ninja-red/30 bg-ninja-red/10">
            ...
            <span className="text-ninja-red font-noto text-sm">Shadow Ninja Academy</span>
          </div>
        </CardHeader>
        ...
        <CardContent className="space-y-6">
          <form onSubmit={handleAuth} className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                className="bg-ninja-gray/50 border-ninja-red/30 text-white placeholder:text-gray-400 focus:border-ninja-red focus:ring-ninja-red/20"
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  className="bg-ninja-gray/50 border-ninja-red/30 text-white placeholder:text-gray-400 focus:border-ninja-red focus:ring-ninja-red/20 pr-10"
            ...
            {error && (
              <div className="text-red-400 text-sm font-noto bg-red-400/10 border border-red-400/30 rounded p-3">
                {error}
              </div>
            )}
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full red-gradient hover:scale-105 transition-all duration-300 font-orbitron font-bold py-6 text-lg"
            >
          ...
          <div className="text-center">
            <button
              ...
              className="text-gray-400 hover:text-ninja-red transition-colors duration-300 font-noto"
            >
